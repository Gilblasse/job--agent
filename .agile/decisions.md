...
| 5 | Registry seeded from outscal/OpenJobs, filtered | With no cross-company search anywhere, an empty registry means an empty results table. 1,755 boards, 1,296 on P1 platforms. |
